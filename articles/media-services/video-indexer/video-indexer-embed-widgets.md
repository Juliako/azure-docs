...
> [!NOTE]
> If you have issues with sharing your video links, try adding the ‘location’ parameter to the URL. The parameter should be set to the [Azure regions in which Video Indexer exists](regions.md). For example, `https://www.videoindexer.ai/accounts/00000000-0000-0000-0000-000000000000/videos/b2b2c74b8e/?location=trial`.
